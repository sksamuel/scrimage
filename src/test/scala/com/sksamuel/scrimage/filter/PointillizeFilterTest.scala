...
class PointillizeFilterTest extends FunSuite with BeforeAndAfter with OneInstancePerTest {
    ...
    val octagonal = getClass.getResourceAsStream("/bird_small_pointillize_octagonal.png")
    val triangular = getClass.getResourceAsStream("/bird_small_pointillize_triangular.png")
