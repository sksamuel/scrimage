...
Tiles the source image into a larger image. `RepeaterFilter(columns, rows)` produces an image `columns` times the source width and `rows` times the source height, with the source drawn into every cell — so `RepeaterFilter(3, 2)` repeats the image 3 across and 2 down.

=== "Java"

    ```
    ImmutableImage transformed = image1.transform(new RepeaterFilter(3, 2))
    ```

=== "Kotlin"

    ```
    val transformed = image1.transform(RepeaterFilter(3, 2))
    ```

=== "Scala"

    ```
    val transformed = image1.transform(new RepeaterFilter(3, 2))
    ```

|  Input | Output |
| ------ | --------- |
| <a href='https://raw.githubusercontent.com/sksamuel/scrimage/master/docs/images/repeater_input1.jpeg'><img src='https://raw.githubusercontent.com/sksamuel/scrimage/master/docs/images/repeater_input1.jpeg' width='300'><a/> |<a href='https://raw.githubusercontent.com/sksamuel/scrimage/master/docs/images/repeater_output1.png'><img src='https://raw.githubusercontent.com/sksamuel/scrimage/master/docs/images/repeater_output1.png' width='300'><a/> |
