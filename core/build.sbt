...
libraryDependencies ++= Seq(
  ...
  "com.twelvemonkeys.imageio"     % "imageio-core"            % "3.0.1",
  "com.twelvemonkeys.imageio"     % "imageio-metadata"        % "3.0.1",
  "com.twelvemonkeys.imageio"     % "imageio-jpeg"            % "3.0.1",
  "com.twelvemonkeys.common"      % "common-lang"             % "3.0.1",
  "com.twelvemonkeys.common"      % "common-io"               % "3.0.1",
  "com.twelvemonkeys.common"      % "common-image"            % "3.0.1",
