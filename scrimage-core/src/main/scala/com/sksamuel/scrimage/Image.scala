...
class Image(awt: BufferedImage, val metadata: ImageMetadata) extends MutableAwtImage(awt) {
  ...
  /**
    ...
    *
    * @param background the colour to use as the background for the empty rows/columns
  ...
  /**
    ...
    */
  def trimLeft(k: Int): Image = trim(k, 0, 0, 0)
  ...
  /**
    ...
    */
  def trimRight(k: Int): Image = trim(0, 0, k, 0)
  ...
  /**
    ...
    */
  def trimBottom(k: Int): Image = trim(0, 0, 0, k)
