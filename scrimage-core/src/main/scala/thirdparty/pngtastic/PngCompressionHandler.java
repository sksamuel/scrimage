...
public interface PngCompressionHandler {
   ...
   */
  byte[] inflate(ByteArrayOutputStream deflatedImageData) throws IOException;
   ...
   */
  byte[] deflate(byte[] inflatedImageData, Integer compressionLevel, boolean concurrent) throws IOException;
}