...
class ImageMetadataTest : WordSpec({
   ...
   "metadata" should {
      "read EXIF" {
         ...
         meta.tags().toList().shouldContain(Tag("ISO Speed Ratings", 34855, "2500", "2500"))
         meta.tags().toList().shouldContain(Tag("Image Width", 256, "4928", "4928 pixels"))
         meta.tags().toList().shouldContain(Tag("White Balance Mode", 41987, "0", "Auto white balance"))
      }
   }
