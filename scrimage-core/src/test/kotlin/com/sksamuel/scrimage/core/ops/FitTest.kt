...
class FitTest : FunSpec({
   ...
   val chip = ImmutableImage.loader().fromResource("/transparent_chip.png")
   ...
   test("when fitting an image the output image should match as expected") {
      ...
      val expected = ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/bird_fitted2.png")
   ...
   test("a fitted image can be aligned to centre") {
      ...
      actual1 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/bird_small_aligned_centre.png")
      actual2 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/turing_aligned_centre.png")
   }
   ...
   test("a fitted image can be aligned to top left") {
      ...
      actual1 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/bird_small_aligned_top_left.png")
      actual2 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/turing_aligned_top_left.png")
   }
   ...
   test("a fitted image can be aligned to top right") {
      ...
      actual1 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/bird_small_aligned_top_right.png")
      actual2 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/turing_aligned_top_right.png")
   }
   ...
   test("a fitted image can be aligned to bottom right") {
      ...
      actual1 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/bird_small_aligned_bottom_right.png")
      actual2 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/turing_aligned_bottom_right.png")
   }
   ...
   test("a fitted image can be aligned to bottom left") {
      ...
      actual1 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/bird_small_aligned_bottom_left.png")
      actual2 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/turing_aligned_bottom_left.png")
   }
   ...
   test("a fitted image can be aligned to centre left") {
      ...
      actual1 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/bird_small_aligned_centre_left.png")
      actual2 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/turing_aligned_centre_left.png")
   }
   ...
   test("a fitted image can be aligned to centre right") {
      ...
      actual1 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/bird_small_aligned_centre_right.png")
      actual2 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/turing_aligned_centre_right.png")
   }
   ...
   test("a fitted image can be aligned to top cente") {
      ...
      actual1 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/bird_small_aligned_top_centre.png")
      actual2 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/turing_aligned_top_centre.png")
   }
   ...
   test("a fitted image can be aligned to bottom centre") {
      ...
      actual1 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/bird_small_aligned_bottom_centre.png")
      actual2 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/turing_aligned_bottom_centre.png")
   }
