...
class FitTest : FunSpec({
   ...
   val small = ImmutableImage.loader().fromResource("/bird_small.png")
   val turing = ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/turing.jpg")
   ...
   test("when fitting an image the output image should match as expected") {
      val fitted = turing.fit(900, 300, java.awt.Color.RED)
      val expected = ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/fit/turing_fitted.png")
      fitted.pixels().size shouldBe expected.pixels().size
   ...
   test("a fitted image can be aligned to centre") {
      ...
      actual1 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/fit/bird_small_aligned_centre.png")
      actual2 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/fit/turing_aligned_centre.png")
   }
   ...
   test("a fitted image can be aligned to top left") {
      ...
      actual1 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/fit/bird_small_aligned_top_left.png")
      actual2 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/fit/turing_aligned_top_left.png")
   }
   ...
   test("a fitted image can be aligned to top right") {
      ...
      actual1 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/fit/bird_small_aligned_top_right.png")
      actual2 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/fit/turing_aligned_top_right.png")
   }
   ...
   test("a fitted image can be aligned to bottom right") {
      ...
      actual1 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/fit/bird_small_aligned_bottom_right.png")
      actual2 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/fit/turing_aligned_bottom_right.png")
   }
   ...
   test("a fitted image can be aligned to bottom left") {
      ...
      actual1 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/fit/bird_small_aligned_bottom_left.png")
      actual2 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/fit/turing_aligned_bottom_left.png")
   }
   ...
   test("a fitted image can be aligned to centre left") {
      ...
      actual1 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/fit/bird_small_aligned_centre_left.png")
      actual2 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/fit/turing_aligned_centre_left.png")
   }
   ...
   test("a fitted image can be aligned to centre right") {
      ...
      actual1 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/fit/bird_small_aligned_centre_right.png")
      actual2 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/fit/turing_aligned_centre_right.png")
   }
   ...
   test("a fitted image can be aligned to top cente") {
      ...
      actual1 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/fit/bird_small_aligned_top_centre.png")
      actual2 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/fit/turing_aligned_top_centre.png")
   }
   ...
   test("a fitted image can be aligned to bottom centre") {
      ...
      actual1 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/fit/bird_small_aligned_bottom_centre.png")
      actual2 shouldBe ImmutableImage.loader().fromResource("/com/sksamuel/scrimage/fit/turing_aligned_bottom_centre.png")
   }
})
